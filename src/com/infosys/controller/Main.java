...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                if (user.getRole().equals("Client")) {
                    while (optionChoice != 0) {
                        ...
                        } catch (TaskLimitException | UserLimitException e) {
                            System.out.println(e.getMessage());
                            System.exit(1); // Exit the program immediately
            ...
            } catch (RoleSelectionException | PasswordException | UserLimitException | UserExistsException e) {
                System.out.println(e.getMessage());
                if (e instanceof UserLimitException) {
                    System.exit(1); // Exit the program immediately for UserLimitException
                }
            }
        }
    }
